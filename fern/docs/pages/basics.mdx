...
3. **Zuora supports multiple payment terms.** - True or false?
  ...
  <p> True. You can specify the payment terms your business uses as well as set a default. Check <a href="https://knowledgecenter.zuora.com/Zuora_Billing/Configure_billing_settings/Subscription_and_order_settings/Define_payment_terms" target="_blank">Define payment terms</a>. After the payment term passes, the invoice is marked overdue. </p>
